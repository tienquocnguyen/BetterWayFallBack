...
var breadandbakeryProducts = [new Product({
...
var done = 0;
for (var i = 0; i < breadandbakeryProducts.length; i++){
    breadandbakeryProducts[i].save(function(err, result){
        done++;
        if (done === breadandbakeryProducts.length){
            exit();
        }
    });
}
